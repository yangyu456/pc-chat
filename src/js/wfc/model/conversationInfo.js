...
export default class ConversationInfo {
    ...
    static protoConversationToConversationInfo(obj) {
        ...
        conversationInfo.conversation = new Conversation(
            obj.conversationType,
            obj.target,
            obj.line
        );
        conversationInfo.lastMessage = Message.fromProtoMessage(
            obj.lastMessage
        );
    ...
    static equals(info1, info2) {
        ...
        if (
            unreadCount1.unread !== unreadCount2.unread ||
        ...
        return (
            info1.timestamp === info2.timestamp && info1.draft === info2.draft
        );
    }
}
