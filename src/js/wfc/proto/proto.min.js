...
class WfcImpl {
    ...
    onFriendRequestUpdate() {
        ...
        self.eventEmitter.emit(EventType.FriendRequestUpdate);
    }
    ...
    init(args = []) {
        ...
        proto.setReceiveMessageListener(
            ...
            self.onRecallMessage,
            self.onDeleteRemoteMessage,
            self.onUserReceivedMessage,
            self.onUserReadedMessage
        );
    ...
    async setHiddenNotificationDetail(hide, successCB, failCB) {
        proto.setHiddenNotificationDetail(
            hide,
            () => {
                if (successCB) {
                    successCB();
    ...
    async setHiddenGroupMemberName(groupId, hide, successCB, failCB) {
        proto.setHiddenGroupMemberName(
            groupId,
            hide,
            () => {
                successCB();
    ...
    async getChatroomInfo(chatroomId, updateDt, successCB, failCB) {
        proto.getChatroomInfo(
            chatroomId,
            updateDt,
            (info) => {
                if (successCB) {
                    successCB(
                        Object.assign(new ChatRoomInfo(), JSON.parse(info))
                    );
                }
            },
            (errorCode) => {
    ...
    getConversationUnreadCount(conversation) {
        let unreadCountStr = proto.getConversationUnreadCount(
            JSON.stringify(conversation)
        );
        return Object.assign(new UnreadCount(), JSON.parse(unreadCountStr));
    }
    ...
    getConversationDelivery(conversation) {
        let deliveryStr = proto.getMessageDelivery(
            JSON.stringify(conversation)
        );
    ...
    getMessages(
        ...
        let protoMsgsStr = proto.getMessages(
            JSON.stringify(conversation),
            contentTypes,
            fromIndex,
            before,
